...
<?php
  $title = "説明";
  $message = "この掲示板では 構造式を書くことができます。";
  $message .= "入力した構造式は SMILE形式、JSF形式、MOLFILE形式 で出力できます。<br /><br />";
  $message .= "また、$\TeX$ を利用して数式を書くこともできます。$ \\$ $ 〜 $ \\$ $ で数式を囲むとインラインで、$ \\$\\$ $ 〜 $ \\$\\$ $, $\backslash [$ 〜 $\backslash ] $ などで囲むと別の行として数式を表示できます。";
